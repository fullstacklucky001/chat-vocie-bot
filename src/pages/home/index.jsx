...
import { pushMessage, fetchMessages } from "../../actions/messageAction";
...
function Home() {
  ...
  aiservice.defaults.headers.common["Authorization"] = "Bearer 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";
  ...
  const handleUserInput = (e) => {
    if (e.key === 'Enter') {
      ...
      $('#message-list').append(
        ...
        '<div class="bubble bubble-right message" data-id="' + Date.now() + '">' +
      ...
      aiservice.post('', {
        ...
        $('#message-list').append(
          '<div class="flex items-start justify-start text-justify">' +
          '<div class="bubble bubble-left rick-message" data-id="' + Date.now() + '">' +
          '</div>' +
          '</div>')
  ...
  const handleSubmitClick = () => {
    ...
    setUserMessage(userInputRef.current.value)
    dispatch(pushMessage({
      type: 0, // 0: user , 1: rick
